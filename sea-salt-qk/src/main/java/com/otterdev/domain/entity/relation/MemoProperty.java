...
@Table(
    ...
    uniqueConstraints = {
        @UniqueConstraint(
            name = "uq_memo_property_relation",
            columnNames = {"memo", "property", "created_by"}
        )
    },
    indexes = {
        @Index(
            name = "idx_memo_property_created_by",
...
public class MemoProperty {
    ...
    @JoinColumn(
        ...
        nullable = false,
        foreignKey = @ForeignKey(
            name = "fk_memo_property_property",
            foreignKeyDefinition = 
    ...
    @JoinColumn(
        ...
        referencedColumnName = "id",
        foreignKey = @ForeignKey(
            name = "fk_memo_property_created_by",
            foreignKeyDefinition = 
