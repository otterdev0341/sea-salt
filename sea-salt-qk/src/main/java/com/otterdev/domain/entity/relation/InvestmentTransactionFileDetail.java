...
@Entity
@Table(
    name = "invest_transaction_file_details",
    uniqueConstraints = {
        @UniqueConstraint(
            name = "uq_invest_transaction_file_details_relation",
            columnNames = {"invest_transaction", "file", "created_by"}
        )
    },
    indexes = {
        @Index(
            name = "idx_invest_transaction_file_details_created_by",
...
@AllArgsConstructor
@NoArgsConstructor
public class InvestmentTransactionFileDetail {
    ...
    @JoinColumn(
        ...
        foreignKey = @ForeignKey(
            name = "fk_invest_transaction_file_details_invest",
    ...
    @JoinColumn(
        ...
        nullable = false,
        foreignKey = @ForeignKey(
            name = "fk_invest_transaction_file_details_file",
            foreignKeyDefinition = 
    ...
    @JoinColumn(
        ...
        referencedColumnName = "id",
        foreignKey = @ForeignKey(
            name = "fk_invest_transaction_file_details_created_by",
            foreignKeyDefinition = 
