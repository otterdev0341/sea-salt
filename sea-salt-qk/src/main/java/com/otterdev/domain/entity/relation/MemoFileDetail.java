...
@Table(
    ...
    uniqueConstraints = {
        @UniqueConstraint(
            name = "uq_memo_file_details_relation",
            columnNames = {"memo", "file", "created_by"}
        )
    },
    indexes = {
        @Index(
            name = "idx_memo_file_details_created_by",
...
public class MemoFileDetail {
    ...
    @JoinColumn(
        ...
        foreignKey = @ForeignKey(
            name = "fk_memo_file_details_memo",
            foreignKeyDefinition = 
                "FOREIGN KEY (memo) REFERENCES memos(id) " +
    ...
    @JoinColumn(
        ...
        nullable = false,
        foreignKey = @ForeignKey(
            name = "fk_memo_file_details_file",
            foreignKeyDefinition = 
    ...
    @JoinColumn(
        ...
        referencedColumnName = "id",
        foreignKey = @ForeignKey(
            name = "fk_memo_file_details_created_by",
            foreignKeyDefinition = 
