...
@ApplicationScoped
class PropertyStatusRepositoryImpl implements InternalPropertyStatusService {

    private final PropertyStatusRepositoryImpl propertyStatusRepository;

    @Inject
    public PropertyStatusRepositoryImpl(PropertyStatusRepositoryImpl propertyStatusRepository) {
